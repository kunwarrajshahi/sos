...
class _MapScreenState extends State<MapScreen> {
  ...
  void _startJourney() {
    ...
    _showInfoSnackBar('Journey started. SOS auto-triggers if you go off-route.');
  }
  ...
  void _evaluateJourneyProgress(LatLng current) {
    ...
    final deviation = _distanceToPolylineMeters(current, _journeyRouteLocations);
    if (mounted) {
      setState(() {
    ...
    if (deviation > _journeyDeviationThresholdMeters && !_hasAutoSosTriggered) {
      ...
      unawaited(() async {
        ...
        if (didTrigger) {
          ...
          _showInfoSnackBar('Route deviation detected, but SOS is already active.');
        }
      }());
    }
  }
            ...
            () => Row(
              children: [
                ...
                Switch(
                  ...
                  onChanged: (val) => _sosHeatmapController.toggleVisibility(val),
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      if (!_isJourneyActive && _journeyRouteLocations.isNotEmpty)
                        FilledButton(
